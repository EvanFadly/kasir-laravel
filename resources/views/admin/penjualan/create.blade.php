            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('penjualan.index') }}" class="btn btn-warning btn-sm float-right"><i
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped">
                                ...
                                <tbody id="penjualan">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger" onclick="hapusProduk(this)"><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                        ...
                        <button type="button" class="btn btn-primary mt-3" onclick="tambahProduk()"><i class="fas fa-plus"> </i> Produk</button>
                    </div>
